...
public class ThrowController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        reticle.DOFade(0, 0);
        charSounds = GetComponent<wwise_CharSounds>();
    ...
    void Update()
    {
        ...
        if(Input.GetMouseButtonDown(1) || Input.GetKeyDown(KeyCode.LeftShift) && hasWeapon)
        {
            Aim(true, true, 0);
            charSounds.Play_Pull();
            
        }

        if(Input.GetMouseButtonUp(1) || Input.GetKeyUp(KeyCode.LeftShift) && hasWeapon)
        {
            Aim(false, true, 0);
